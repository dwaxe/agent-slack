...
- Use bare HTTP(S) URLs or Slack mrkdwn for labeled links (`<https://example.com|label>`). Do not use Markdown-style links (`[label](https://example.com)`); `agent-slack` warns and sends them literally.
