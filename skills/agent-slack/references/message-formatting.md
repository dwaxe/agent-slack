...
- Links may be bare HTTP(S) URLs or use Markdown (`[label](https://example.com)`) or Slack mrkdwn (`<https://example.com|label>`); `message send` and `message edit` normalize all three, including links in lists.
